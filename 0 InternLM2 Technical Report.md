...
Evaluation Results。我们在表 15 中报告了 InternLM2 在长上下文基准上的评估结果。InternLM2 的所有变体都在两个基准上展示了强大的长上下文建模性能。  
InternLM2-Chat-20B-SFT 在 L-Eval 上实现了最佳性能，并大幅优于同类产品。在 LongBench 上，InternLM2-Chat-7B-SFT 在 4 个输出方面优于其他 ≤ 7B 模型  
